    ...
    return (
        <section className="relative overflow-hidden hero-pattern py-24 md:py-40">
            ...
            <div className="container mx-auto px-6 text-center relative z-10">
                ...
                <p>
                    <a href="#" className="bg-brand-accent text-brand-dark font-bold text-lg rounded-full py-4 px-10 hover:bg-brand-accent-dark transition-all duration-300 inline-block transform hover:scale-105 cta-glow">Start Build for Free</a>
                </p>
            </div>
        </section>
    );
